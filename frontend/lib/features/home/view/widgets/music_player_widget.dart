                ...
                children: [
                  SliderTheme(
                    ...
                    child: Slider(
                      ...
                      max: vm.duration.inSeconds.toDouble().clamp(1, double.infinity),
                      onChanged: (v) {
                      ...
                      Row(
                        children: [
                          IconButton(
                            ...
                            color: Colors.white,
                            iconSize: 28,
                            onPressed: vm.isLoading ? null : () => vm.previousTrack(),
                          ),
                          Container(
                            decoration: BoxDecoration(
                            ...
                            child: IconButton(
                              ...
                              onPressed: vm.isLoading ? null : () => vm.togglePlayPause(),
                            ),
                          ),
                          IconButton(
                            ...
                            color: Colors.white,
                            iconSize: 28,
                            onPressed: vm.isLoading ? null : () => vm.nextTrack(),
                          ),
                        ],
                      ),
